...
export default function EventDetails() {
  return (
    <>
      ...
      <motion.section
        id="categories"
        className="py-20 md:py-28 bg-gradient-to-b from-[#ffe6ec]/60 via-[#e6f7ff]/60 to-[#e6ffe6]/60"
        initial={{ opacity: 0, y: 40 }}
        whileInView={{ opacity: 1, y: 0 }}
        viewport={{ once: true, amount: 0.3 }}
        transition={{ duration: 0.8, ease: 'easeOut' }}
      ...
      {/* Route Map Section */}
      <motion.section
        className="py-20 md:py-28 bg-gradient-to-b from-[#e6ffe6]/60 via-[#fffbe6]/60 to-[#ffe6ec]/60"
        initial={{ opacity: 0, y: 40 }}
        whileInView={{ opacity: 1, y: 0 }}
        viewport={{ once: true, amount: 0.3 }}
        transition={{ duration: 0.8, ease: 'easeOut' }}
